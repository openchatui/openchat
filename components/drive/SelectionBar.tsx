...
import { X, UserPlus, Download, FolderOpen, Link as LinkIcon, MoreVertical } from "lucide-react"
...
export function SelectionBar({ count, onClear, onTrashSelected }: SelectionBarProps) {
  return (
