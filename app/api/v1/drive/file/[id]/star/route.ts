...
export async function PATCH(request: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  try {
    ...
    const res = await db.file.updateMany({ where: { id, userId }, data: { meta, updatedAt: nowSec } })
    ...
    console.error('PATCH /api/v1/drive/file/{id}/star error:', error)
